...
const slides: Slide[] = [
  ...
  // --------------------------------------------------------------------------
  // WANT TO ADD MORE SLIDES? COPY & PASTE THE TEMPLATE BELOW
  // --------------------------------------------------------------------------
  /*
  {
    id: "my_new_slide",
    ...
    type: "content", 
    html: slideWrapper(`
        <h2 class="text-2xl font-semibold mb-4">My New Slide Title</h2>
        <p>This is a new slide I added!</p>
    `),
  },
  {
    id: "my_new_question_slide",
    index: 7,
    type: "question", 
    html: slideWrapper(`
        <h2 class="text-2xl font-semibold mb-4">My Question</h2>
        <p>Look at your phone to answer.</p>
    `),
    questionId: "my_unique_question_id" // Must match an ID in the 'questions' array below
  },
  */
];
...
Which of the following patterns best describes this presentation?`,
  ...
  /*
  {
    id: "my_unique_question_id",
    stem: "What is 2 + 2?",
    options: ["3", "4", "5", "Unknown"],
    correctIndex: 1, // 0-based index (so 1 means the second option, "4")
